...
export function Bookshelf() {
  ...
  return (
    ...
    >
      <div className="absolute top-16 left-0 right-0 text-center z-10 pointer-events-none mix-blend-screen">
        <h1 className="font-cinzel text-amber-500/80 text-sm tracking-[0.3em] uppercase">
          A Dig Into My World
        </h1>
      </div>
      ...
      <div className="w-full max-w-7xl px-4 md:px-8 relative z-30 scale-[0.85] origin-center mt-12">
